...
#import "Constants.h"
#define KICreateStatusImageKey(USER_ID)         [NSString stringWithFormat:@"images/status/%@/%d.jpg", USER_ID, (int)[[NSDate date] timeIntervalSince1970]]
   ...
   didFinishPickingMediaWithInfo:(NSArray *)info {
    ...
    for (NSDictionary *imageDictionary in info) {
        if ([ALAssetTypePhoto isEqualToString:imageDictionary[UIImagePickerControllerMediaType]]) {
            ...
            uploadRequest.key = KICreateStatusImageKey(@"24876");
